...
function Card({username}){
    ...
    return(
        ...
        <div class="flex-none w-52 relative">
          <img src="https://images.pexels.com/photos/26385142/pexels-photo-26385142/free-photo-of-hudsons-bay-department-store-in-victoria-in-canada.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
        </div>
